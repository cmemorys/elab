...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>E-LEARNING LAB Universitas Singaperbangsa Karawang | Registrasi</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../"><b>E-LAB</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Register for access elearning</p>

    <form action="<?php echo base_url(); ?>Main/auth_register" method="post">
