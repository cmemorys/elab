...
<head>
  ...
  <?php 
    if(isset($dtable)){
      echo '<link rel="stylesheet" href="'.base_url().'vendor/datatables.net-bs/css/dataTables.bootstrap.min.css">';
    }
  ?>
  <?php 
    if(isset($select2)){
      echo '<link rel="stylesheet" href="'.base_url().'vendor/select2/dist/css/select2.min.css">';
    }
  ?>
